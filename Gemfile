...
group :development do
  ...
  gem 'dm-constraints', DM_VERSION, github: 'basex/dm-constraints', branch: GIT_BRANCH # move to datamapper/dm-validations after merge with release-1.2 is accepted
